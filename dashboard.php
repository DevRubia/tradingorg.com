            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        .   User: <?=$userProperties['displayName']?></a>
                        </li>
                    </ul>
                    <form class="d-flex">
...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header bg-primary shadow-sm align-items-center dropdown">
                ...
                <div class="col ">
                    ...
                    <div class="col">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary">USD: <?=$userProperties['widthdrawal']?></button>
                        </div>
                        </div>
                    </div>
                    </div>
